...
% h1 = fr(fr > harmonic_n(1)-0.2 & fr< harmonic_n(1)+0.2);
 %[~, y1_h1] = ismember(h1,fr);
   % Signal_values_h1 = P1(y1_h1);
    %Signal_peaks_h1 = max(Signal_values_h1);
 %[~, Fund_Freq] = ismember(Signal_peaks_h1, P1);
   % FF_loc = fr(Fund_Freq); 
...
Signal_peaks = [Signal_peaks_ff Signal_peaks_h2 Signal_peaks_h3 Signal_peaks_h4 Signal_peaks_h5 Signal_peaks_h6 Signal_peaks_h7 Signal_peaks_h8 Signal_peaks_h9 Signal_peaks_h10 Signal_peaks_h11 Signal_peaks_h12 Signal_peaks_h13 Signal_peaks_h14 Signal_peaks_h15 Signal_peaks_h16 Signal_peaks_h17 Signal_peaks_h18 Signal_peaks_h19 Signal_peaks_h20];
...
%set(gca, 'YScale', 'log')
hold off
title('HR ML Single-Sided Amplitude Spectrum')
xlabel('f(Hz)')
ylabel('P1(f)')


%saveas(figure(1), 'HR_ML.png')
